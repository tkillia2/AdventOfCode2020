...
# list comprehensions to find mine if not in seat_id already
options = [ele for ele in range(min(seat_id),max(seat_id)) if ele not in seat_id]
print("PART 1")
print(f"MAX Seat ID: {high}")

mine = options[0]
print("PART 2:")
print(f"My Seat ID: {mine}")
