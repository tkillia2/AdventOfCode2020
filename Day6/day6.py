...
# Exact same start as day4 get each question group in one list
with open("questions.txt", "r") as file:
    read = file.read()
    entries = read.strip().split("\n\n")
    #entries = entries.replace("\n","")
total = 0
# One line for fun
### HAD THIS WRONG FOR SO LONE BC CHROME TRANSLATED POLISH TO ENGLISH!!!
#print("PART 1:")
part1 = sum([total + len(set(entry.replace("\n",""))) for entry in entries])
